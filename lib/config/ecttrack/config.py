...
# MODEL
cfg.MODEL = edict()
cfg.MODEL.PRETRAIN_FILE = "mobilevitv3-1.0.pt"
...
cfg.MODEL.BACKBONE.TYPE = "mobilevitv3"
...
cfg.LORA.PRETRAIN_FILE = "MobileViTv3_Track_ep0300.pth.tar"
cfg.LORA.SHARED_MODE = 'addition'
cfg.LORA.TASKS = ['CLS','REG']
cfg.LORA.SHARED_SCALE = 4.0
cfg.LORA.TASK_SCALE = 4.0
cfg.LORA.DROPOUT =  0.5
cfg.LORA.TRAINABLE_SCALE_SHARED = False
cfg.LORA.TRAINABLE_SCALE_PER_TASK = False
cfg.LORA.INTERMEDIATE_SPECIALIZATION = False
cfg.LORA.PROJ_ENABLED = True
cfg.LORA.QKV_ENABLED = True
cfg.LORA.ATTN_PROJ_ENABLED = True
cfg.LORA.FC1_ENABLED = True
cfg.LORA.FC2_ENABLED = True
cfg.LORA.LOCAL_ENABLED = True

cfg.LORA.R_PER_TASK = edict()
cfg.LORA.R_PER_TASK.shared = 16
cfg.LORA.R_PER_TASK.CLS = 16
cfg.LORA.R_PER_TASK.REG = 16
